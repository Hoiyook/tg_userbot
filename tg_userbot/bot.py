...
BOT_COMMANDS = (
    ...
    ("retry", "查看待重试列表"),
    ("retry_all", "重放全部待重试任务"),
    ("retry_del", "从待重试移除：/retry_del 序号"),
    ("queue_del", "从队列移除：/queue_del 序号"),
    ("done", "查看最近下载记录"),
    ("thread", "查看/设置并行下载路数"),
    ("dedup", "查看/设置重复媒体去重"),
    ("caption_filter", "Caption 命名清洗规则列表"),
    ("listen", "标签监听：状态与规则列表"),
    ("listen_add", "新增监听规则：/listen_add 聊天 标签 [目标] [on]"),
    ("listen_edit", "修改监听规则：/listen_edit 序号"),
    ("listen_del", "删除监听规则：/listen_del 序号"),
    ("listen_scan", "标签监听立即扫描"),
    ...
    ("wl_scan", "白名单立即扫描"),
    ("wl_since", "回补存量：/wl_since 聊天 消息id"),
    ...
    ("paw", "Pawchive：状态总览（失败画像/扫描进度）"),
    ("paw_plan", "Pawchive 扫描作者入队：/paw_plan 作者 [all]"),
    ("paw_progress", "Pawchive 按作者进度：/paw_progress 作者"),
    ("paw_search", "Pawchive 搜作者：/paw_search 关键词"),
    ("paw_post", "Pawchive 单帖获取/刷新：/paw_post URL|ID"),
    ("paw_pr", "Pawchive 帖子详情报告：/paw_pr 行id|URL"),
    ("paw_att", "Pawchive 帖子附件外链：/paw_att 行id|URL"),
    ("paw_find", "Pawchive 按名称查询：/paw_find 关键词"),
    ("paw_manual", "Pawchive 待人工外链工作台"),
    ("paw_done", "Pawchive 标完成：/paw_done 行id|起-止|作者"),
    ("paw_fail", "Pawchive 非死链失败明细"),
    ("paw_retry", "Pawchive 重投失败帖：/paw_retry 行id|all"),
    ("paw_archive", "Pawchive 归档明细/执行归档"),
    ("paw_backfill", "Pawchive 回填作者历史帖"),
    ("paw_since", "Pawchive 扫描时间下限：/paw_since 日期|off"),
    ("paw_pause", "Pawchive 暂停下载 worker"),
    ...
    ("sqlt", "SQL 查询模板列表"),
    ("sqlt_add", "保存 SQL 模板：/sqlt_add 名字 SQL"),
    ("sqlt_del", "删除 SQL 模板：/sqlt_del 名字"),
    ("caption_filter_add", "添加清洗规则：/caption_filter_add 规则"),
    ("caption_filter_del", "删除清洗规则：/caption_filter_del 序号"),
    ("caption_filter_test", "试清洗：/caption_filter_test 原文"),
    ("clearmsg", "清理程序产生的消息"),
    ("help", "查看全部命令"),
)
